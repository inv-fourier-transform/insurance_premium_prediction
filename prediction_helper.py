...
model_u25 = joblib.load("artifacts/model_u25.joblib")
model_others = joblib.load("artifacts/model_others.joblib")
scaler_u25 = joblib.load("artifacts/scaler_u25.joblib")
scaler_others = joblib.load("artifacts/scaler_others.joblib")
...
def preprocess_input(input_dict):
    ...
    expected_columns = [
        'age', 'number_of_dependants', 'income_level', 'insurance_plan', 'genetical_risk', 'normalized_total_risk_score',
    ...
    df['normalized_total_risk_score'] = calculate_normalized_risk(input_dict['Medical History'])
...
def predict(input_dict):
    ...
    if input_dict['Age'] <= 25:
        prediction = model_u25.predict(input_df)
    else:
